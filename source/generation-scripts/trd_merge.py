#!/usr/bin/env python3
"""Merge TRD cover + body into single final PDF. Normalizes page sizes."""
from pypdf import PdfReader, PdfWriter
from pypdf.generic import RectangleObject

cover_path = '/home/z/my-project/scripts/trd_cover.pdf'
body_path = '/home/z/my-project/scripts/trd_body.pdf'
output_path = '/home/z/my-project/download/VNBOT_TRD.pdf'
...
writer.add_metadata({
    ...
    '/Keywords': 'VNBOT, TRD, technical requirements, architecture, backend, MCP, LLM, observability',
})
