#!/usr/bin/env python3
"""Merge Volumen I cover + body into single final PDF."""
from pypdf import PdfReader, PdfWriter
from pypdf.generic import RectangleObject

cover_path = '/home/z/my-project/scripts/vol1_cover.pdf'
body_path = '/home/z/my-project/scripts/vol1_body.pdf'
output_path = '/home/z/my-project/download/VNBOT_VOL1_DATOS_SEGURIDAD_EXTENSIBILIDAD.pdf'
...
writer.add_metadata({
    ...
    '/Subject': 'Compilado v1.0.0-draft — Modelo de Datos (07) + Seguridad (08) + MCP y Skills (09)',
    '/Creator': 'Z.ai',
    '/Producer': 'Z.ai PDF Pipeline',
    '/Keywords': 'VNBOT, data model, security, privacy, MCP, skills, agents, extensibility, compilation',
})
