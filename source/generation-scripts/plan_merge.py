#!/usr/bin/env python3
"""Merge Plan Implementación cover + body into single final PDF."""
from pypdf import PdfReader, PdfWriter
from pypdf.generic import RectangleObject

cover_path = '/home/z/my-project/scripts/plan_cover.pdf'
body_path = '/home/z/my-project/scripts/plan_body.pdf'
output_path = '/home/z/my-project/download/VNBOT_PLAN_IMPLEMENTACION.pdf'
...
writer.add_metadata({
    ...
    '/Keywords': 'VNBOT, plan, implementation, phases, milestones, roadmap, backlog, releases',
})
