#!/usr/bin/env python3
"""Merge Volumen II cover + body into single final PDF."""
from pypdf import PdfReader, PdfWriter
from pypdf.generic import RectangleObject

cover_path = '/home/z/my-project/scripts/vol2_cover.pdf'
body_path = '/home/z/my-project/scripts/vol2_body.pdf'
output_path = '/home/z/my-project/download/VNBOT_VOL2_ROADMAP_SYNC.pdf'
...
writer.add_metadata({
    ...
    '/Keywords': 'VNBOT, roadmap, sync, multi-device, offline-first, version vectors, conflict resolution',
})
